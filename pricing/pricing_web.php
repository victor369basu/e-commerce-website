...
<html lang="en">
  <head>
    ...
    <title>Develop A.I. through web application</title>
...
if($_GET){
  if ($_GET['n2p_web']){
    $_SESSION['price'] = 5;
    $_SESSION['product'] = 'n2p_web';
  }
  if ($_GET['p2m_web']){
    $_SESSION['price'] = 20;
    $_SESSION['product'] = 'p2m_web';
  }
  if ($_GET['m2gm_web']){
    $_SESSION['price'] = 39;
    $_SESSION['product'] = 'm2gm_web';
  }
...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <p class="lead">Develop yourself from noob to Grand-Master indeploying A.I. models through web-application. We offer you the best skill in the cheapest price.
  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      ...
      <div class="card-body">
        ...
        <button type="button" class="btn btn-lg btn-block btn-outline-primary" name='n2p_web'
        onclick="window.location.href='?n2p_web=1';">Add to Cart</button>
      </div>
    </div>
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <div class="card-body">
        ...
        <button type="button" class="btn btn-lg btn-block btn-primary" name='p2m_web'
        onclick="window.location.href='?p2m_web=1';">Add to Cart</button>
      </div>
    </div>
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <div class="card-body">
        ...
        <ul class="list-unstyled mt-3 mb-4">
          <li>Get Free server for hosting and free web app templates.</li>
          <li>Get job Offers and referals</li>
          <li>Phone and email support</li>
          <li>Help center access</li>
        </ul>
        <button type="button" class="btn btn-lg btn-block btn-primary" name='m2gm_web'
        onclick="window.location.href='?m2gm_web=1';">Add to Cart</button>
      </div>
    </div>
  </div>
