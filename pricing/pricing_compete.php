...
if($_GET){
  if ($_GET['noP_cpt']){
    $_SESSION['price'] = 5;
    $_SESSION['product'] = 'noP_cpt';
  }
  if ($_GET['P_cpt']){
    $_SESSION['price'] = 29;
    $_SESSION['product'] = 'P_cpt';
  }
...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <p class="lead">Compete and test your skills with other masters and grand masters.</p>
</div>
  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
        <h4 class="my-0 font-weight-normal">Compete for no Prize money</h4>
      </div>
      <div class="card-body">
        <h1 class="card-title pricing-card-title">$5 <small class="text-muted">/ mo</small></h1>
        <ul class="list-unstyled mt-3 mb-4">
          <li>Competitions are easy</li>
          <li>Increase your reputation in the community by gaining points.</li>
          <li>Compete for research based projects.</li>
          <li>Email support</li>
          <li>Help center access</li>
        </ul>
        <button type="button" class="btn btn-lg btn-block btn-outline-primary" name='noP_cpt'
        onclick="window.location.href='?noP_cpt=1';">Add to Cart</button>
      </div>
    </div>

    <div class="card mb-4 shadow-sm">
      <div class="card-header">
        <h4 class="my-0 font-weight-normal">Compete for Prize money</h4>
      </div>
      <div class="card-body">
        <h1 class="card-title pricing-card-title">$29 <small class="text-muted">/ 3mo</small></h1>
        <ul class="list-unstyled mt-3 mb-4">
          <li>Competitions are Tough.</li>
          <li>Increase your reputation in the community by gaining points.</li>
          <li>Get job Offers and referals</li>
          <li>Phone and email support</li>
          <li>Help center access</li>
        </ul>
        <button type="button" class="btn btn-lg btn-block btn-primary" name='P_cpt'
        onclick="window.location.href='?P_cpt=1';">Add to Cart</button>
      </div>
    </div>
  </div>
