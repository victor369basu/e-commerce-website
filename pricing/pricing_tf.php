...
<html lang="en">
  <head>
    ...
    <title>Develop with Tensorflow</title>
...
if($_GET){
  if ($_GET['n2p_tf']){
    $_SESSION['price'] = 5;
    $_SESSION['product'] = 'n2p_tf';
  }
  if ($_GET['p2m_tf']){
    $_SESSION['price'] = 20;
    $_SESSION['product'] = 'p2m_tf';
  }
  if ($_GET['m2gm_tf']){
    $_SESSION['price'] = 39;
    $_SESSION['product'] = 'm2gm_tf';
  }
...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <p class="lead">Develop yourself from noob to Grand-Master in Tensorflow. We offer you the best skill in the cheapest price.
  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      ...
      <div class="card-body">
        ...
        <button type="button" class="btn btn-lg btn-block btn-outline-primary" name='n2p_tf'
        onclick="window.location.href='?n2p_tf=1';">Add to Cart</button>
      </div>
    </div>
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <div class="card-body">
        ...
        <button type="button" class="btn btn-lg btn-block btn-primary" name='p2m_tf'
        onclick="window.location.href='?p2m_tf=1';">Add to Cart</button>
      </div>
    </div>
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <div class="card-body">
        ...
        <button type="button" class="btn btn-lg btn-block btn-primary" name='m2gm_tf'
        onclick="window.location.href='?m2gm_tf=1';">Add to Cart</button>
      </div>
    </div>
  </div>
